...
// Static anonymous cookie values generated once at module load
const ig_did = crypto.randomUUID();
const datr = crypto.randomBytes(18).toString('base64');
const csrftoken = crypto.randomBytes(16).toString('hex');
const anonymousCookies = `ig_did=${ig_did}; datr=${datr}; csrftoken=${csrftoken}`;
