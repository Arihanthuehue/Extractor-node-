...
async function bootstrapSession() {
    ...
    try {
        ...
        const cookieNames = cookiesList.map(c => c.split('=')[0]).join(', ');
        console.log(`Instagram session bootstrapped successfully, cookies: ${cookieNames}`);
    } catch (err) {
 ...
 */
async function fetchUrlWithCurl(url, timeoutSeconds = 20) {
